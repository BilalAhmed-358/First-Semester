...
int main()
{
    ...
    case 6:
        ...
        break;
    case 7:
        printf("Hope you liked my program ;).\n");
        exit(1);
    default:
    {
...
void Dept_Y_salary(struct Employee *ptr)
{
    ...
    for (i = 0; fread(ptr, sizeof(*ptr), 1, fp) > 0; i++)
    {
        ...
        {
            printf("The name of the Employee %d is %s.\nHis employee ID is %d.\nHis salary is %d.\nHis age is %d.\nHis depart id is %c.\nHis depart name is %s.\n\n\n", j + 1, ptr->Emp_name, ptr->Emp_id, ptr->salary, ptr->age, ptr->depart.depart_id, ptr->depart.depart_name);
            j++;
        }
    }
    fclose(fp);
